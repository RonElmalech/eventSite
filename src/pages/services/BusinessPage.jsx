...
const BusinessPage = () => {
  ...
  useEffect(() => {
    // Get business service using our route mapping utility
    const businessService = getServiceForRoute('business');
      ...
      <Container>
        <Box sx={{ py: 8, textAlign: 'center' }}>
          ...
          <Typography variant="body1" sx={{ mt: 2 }}>
            מצטערים, לא הצלחנו למצוא את שירות האירועים העסקיים.
          </Typography>
        </Box>
      </Container>
    );
